...
public class QueryUtils {
     ...
     *
     * //@param requestUrls a {@link String} as an url
     * @return the book titles of all the fetched books
     */
    static List<Book> fetchBooks(String stringUrl) {
        ...
        try {
            ...
            Log.e(LOG_Tag, "Problem Making http request for the search critera");
        }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            e.getMessage();
            Log.e(LOG_Tag, "Problem encountered while retrieving book resutls");
        } finally {
        ...
        try {
            ...
            for (int i = 0; i < books.length(); i++) {
                ...
                if (volume.has("authors")) {
                    ...
                    int noOfAuthor = jsonAuthors.length();
                ...
                if(isSold){
                    JSONObject priceInfo=saleInfo.getJSONObject("retailedPrice");
